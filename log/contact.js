(function() {
  ...
  return (
    ...
    src: "./img/hero.png", alt: "Hero image"})
      ...
      $el('main', {className: "lg:bg-#F1F9FD lg:py-50 over-hidden"}, [
        $el('div', {className: "container", flex: "center"}, [
          $el('form', {action: "/send-contact.php", method: "POST"}, [
            $el('div', {className: "bg-white max-w-480 p-60 m-lg:px-10 graphics", flex: "32 col center"}, [
              $el('h3', {className: "font_lilita sp-0", text: "30 #22A0D9 center"}, ["Contact GlenBob"]),
